...
extern void PyTokenizer_Free(_Post_ptr_invalid_  _At_(tok->encoding, _Post_invalid_ _Post_ptr_invalid_) _At_(tok->buf, _Post_invalid_ _Post_ptr_invalid_) _At_(tok->input, _Post_invalid_ _Post_ptr_invalid_) struct tok_state * tok);
