...
static int freeSubEntry(_Post_ptr_invalid_ rotating_node_t *header, void *arg)
{
...
static int freeEntry(_Post_ptr_invalid_ rotating_node_t *header, void *arg)
{
...
static void clearEntries(_At_(pObj->currentProfilerContext, _Post_ptr_invalid_ ) _At_(pObj->freelistProfilerContext, _Post_ptr_invalid_ ) ProfilerObject *pObj)
{
...
static void
profiler_dealloc(_Post_ptr_invalid_ ProfilerObject *op)
{
