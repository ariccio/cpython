...
static void
Pdata_dealloc(_Post_ptr_invalid_ _At_(self->data, _Post_ptr_invalid_ ) Pdata *self)
{
...
static void
PyMemoTable_Del(_Post_ptr_invalid_  _At_(self->mt_table, _Post_ptr_invalid_ ) PyMemoTable *self)
{
    if (self == NULL)
        return;
...
static void
Pickler_dealloc(_Post_ptr_invalid_ PicklerObject *self)
{
...
static void
Unpickler_dealloc(_Post_ptr_invalid_ _At_(self->marks, _Post_ptr_invalid_ ) _At_(self->input_line, _Post_ptr_invalid_ ) _At_(self->encoding, _Post_ptr_invalid_ ) _At_(self->errors, _Post_ptr_invalid_ ) UnpicklerObject *self)
{
...
static int
Unpickler_clear(_At_(self->marks, _Post_ptr_invalid_ ) _At_(self->input_line, _Post_ptr_invalid_ ) _At_(self->encoding, _Post_ptr_invalid_ ) _At_(self->errors, _Post_ptr_invalid_ ) UnpicklerObject *self)
{
    Py_CLEAR(self->readline);
    Py_CLEAR(self->readinto);
    Py_CLEAR(self->read);
