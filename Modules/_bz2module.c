...
static void
BZ2Compressor_dealloc(_Post_ptr_invalid_ BZ2Compressor *self)
{
...
static void
BZ2Decompressor_dealloc(_Post_ptr_invalid_ _At_(self->input_buffer, _Post_ptr_invalid_ ) _At_(self->lock, _Post_ptr_invalid_ )BZ2Decompressor *self)
{
