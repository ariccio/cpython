...
static void
lock_dealloc(_Post_ptr_invalid_ lockobject *self)
{
...
static void
rlock_dealloc(_Post_ptr_invalid_ rlockobject *self)
{
    if (self->in_weakreflist != NULL)
        PyObject_ClearWeakRefs((PyObject *) self);
...
static void
localdummy_dealloc(_Post_ptr_invalid_ localdummyobject *self)
{
...
static void
local_dealloc(_Post_ptr_invalid_ localobject *self)
{
