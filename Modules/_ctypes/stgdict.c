...
static void
PyCStgDict_dealloc(_Post_ptr_invalid_  _At_(self->format, _Post_ptr_invalid_ ) _At_(self->shape, _Post_ptr_invalid_ ) _At_(self->ffi_type_pointer.elements, _Post_ptr_invalid_ ) StgDictObject *self)
{
