...
static void
Dialect_dealloc(_Post_ptr_invalid_ DialectObj *self)
{
...
static void
Reader_dealloc(_Post_ptr_invalid_  _At_(self->field, _Post_ptr_invalid_ ) ReaderObj *self)
{
...
static void
Writer_dealloc(_Post_ptr_invalid_  _At_(self->rec, _Post_ptr_invalid_ ) WriterObj *self)
{
    PyObject_GC_UnTrack(self);
    Py_XDECREF(self->dialect);
