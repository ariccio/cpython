...
static void
element_dealloc(_Post_ptr_invalid_ ElementObject* self)
{
...
static void
elementiter_dealloc(_Post_ptr_invalid_  _At_(it->parent_stack, _Post_ptr_invalid_ ) ElementIterObject *it)
{
...
static void
treebuilder_dealloc(_Post_ptr_invalid_ TreeBuilderObject *self)
{
    PyObject_GC_UnTrack(self);
...
static void
xmlparser_dealloc(_Post_ptr_invalid_ XMLParserObject* self)
{
    PyObject_GC_UnTrack(self);
