...
static void
partial_dealloc(_Post_ptr_invalid_ partialobject *pto)
{
...
static void
keyobject_dealloc(_Post_ptr_invalid_ keyobject *ko)
{
    Py_DECREF(ko->cmp);
...
static void
lru_list_elem_dealloc(_Post_ptr_invalid_ lru_list_elem *link)
{
    Py_XDECREF(link->key);
...
static void
lru_cache_dealloc(_Post_ptr_invalid_ lru_cache_object *obj)
{
    lru_list_elem *list;
    /* bpo-31095: UnTrack is needed before calling any callbacks */
