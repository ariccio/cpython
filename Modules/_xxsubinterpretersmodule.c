...
static void
_sharedexception_clear(_At_(exc->name, _In_ _Post_invalid_ _Post_ptr_invalid_) _At_(exc->msg, _Post_invalid_ _Post_ptr_invalid_ ) _sharedexception *exc)
{
    if (exc->name != NULL) {
        PyMem_Free(exc->name);
    }
...
static void
_sharedexception_free(_Post_invalid_ _Post_ptr_invalid_ _sharedexception *exc)
{
...
static void
_channelitem_clear(_At_(item->data, _Post_invalid_ _Post_ptr_invalid_ ) _channelitem *item)
{
    if (item->data != NULL) {
        _PyCrossInterpreterData_Release(item->data);
...
static void
_channelitem_free(_Post_invalid_ _Post_ptr_invalid_ _channelitem *item)
{
...
static void
_channelend_free(_Post_invalid_ _Post_ptr_invalid_ _channelend *end)
{
    PyMem_Free(end);
}
