...
void
_Py_FreeCharPArray(_Post_ptr_invalid_ _Null_terminated_ _At_buffer_(array, _Iter_, array[_Iter_] != NULL, _Null_terminated_ _In_ _Post_invalid_ _Post_ptr_invalid_)char *const array[])
{
    Py_ssize_t i;
