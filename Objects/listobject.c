...
static void
list_dealloc(_Post_ptr_invalid_ _At_(op->ob_item, _In_ _Post_invalid_ _Post_ptr_invalid_) PyListObject *op)
{
    Py_ssize_t i;
...
static int
_list_clear(_At_(a->ob_item, _Post_ptr_invalid_ ) PyListObject *a)
{
    Py_ssize_t i;
