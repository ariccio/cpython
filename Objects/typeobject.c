...
static void
type_dealloc(_Post_ptr_invalid_ PyTypeObject *type)
{
    PyHeapTypeObject *et;
    PyObject *tp, *val, *tb;
...
static void
object_dealloc(_Post_invalid_ _Post_ptr_invalid_ PyObject *self)
{
...
static PyObject *
wrap_del(_Post_ptr_invalid_ PyObject *self, PyObject *args, void *wrapped)
{
...
static void
super_dealloc(_Post_ptr_invalid_ PyObject *self)
{
